...
export class MemStorage implements IStorage {
  ...
  private seedVolunteerWorks() {
    ...
    const seed: Array<Omit<VolunteerWork, "id">> = [
      {
        title: "Reef Cleanup Dive — Santa Cruz Island",
        description: "Join certified local divers to remove ghost nets and debris from the reefs surrounding Great Santa Cruz Island in Zamboanga City's bay.",
      ...
      {
        title: "Coral Nursery Maintenance — Basilan Strait",
        description: "Help clean underwater nursery trees, monitor coral fragment growth, and prep colonies for outplanting at our Basilan Strait restoration site.",
        location: "Basilan Strait, Zamboanga City",
      ...
      {
        title: "Cawa-Cawa Boulevard Beach Cleanup",
        description: "A morning shoreline cleanup along Cawa-Cawa Boulevard focused on microplastics and single-use waste. Gloves and eco-bags provided.",
        location: "Cawa-Cawa Boulevard, Zamboanga City",
      ...
      {
        title: "Mangrove Replanting — Rio Hondo",
        description: "Restore the coastal mangrove buffer along Rio Hondo that shields nearby reef zones from sedimentation and land runoff.",
        location: "Rio Hondo, Zamboanga City",
      ...
      {
        title: "School Outreach — WMSU Marine Biology Day",
        description: "We partnered with Western Mindanao State University to teach 120 students from Zamboanga City public schools about coral biology and responsible fishing.",
        location: "Western Mindanao State University, Zamboanga City",
      ...
      {
        title: "Reef Survey — Sibugay Bay",
        description: "Volunteer divers logged coral bleaching observations and fish population data across three reef sites along Sibugay Bay near Zamboanga City.",
        location: "Sibugay Bay, Zamboanga City",
